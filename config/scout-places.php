...
return [
    ...
    */
    ...
    'disableTypoToleranceOnAttributes' => ['postalCode', 'phoneNumber', 'additionnalPhoneNumber'],
    ...
    */
    ...
    'unretrievableAttributes' => ['email', 'long', 'lat', 'hide_address', 'plus_code', 'is_approved'],
