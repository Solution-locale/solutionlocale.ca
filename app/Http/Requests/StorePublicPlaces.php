...
class StorePublicPlaces extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'placeType' => ['required'],
            'region_id' => ['required'],
            'email_business' => ['nullable', 'email', 'required_without_all:url,facebook_url,phoneNumber'],
            'url' => ['nullable', 'url', 'required_without_all:email,facebook_url,phoneNumber'],
            'facebook_url' => ['nullable', 'url', 'required_without_all:url,phoneNumber,email'],
            'hide_address' => ['boolean'],
            'phoneNumber' => ['nullable', 'phone:CA', 'required_without_all:url,facebook_url,email'],
