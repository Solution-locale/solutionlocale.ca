<div class="card border-info mb-1">
  ...
  <div class="card-body text-info">
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
      ...
      @endif
      @if($place->is_closed)
        <a class="btn btn-outline-info" href="{{ route('places.close', ['place' => $place->slug]) }}" role="button" title="Afficher"><i class="fas fa-eye"></i></a>
      @else
        <a class="btn btn-outline-info" href="{{ route('places.close', ['place' => $place->slug]) }}" role="button" title="Cacher"><i class="fas fa-eye-slash"></i></a>
      @endif
