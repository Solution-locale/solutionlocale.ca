...
<div class="btn-group btn-group-toggle" data-toggle="buttons">
    <label class="btn btn-secondary @if(request('vue') == 'grille' || request('vue') === null) active @endif">
        <a href="{{ \App\Http\Controllers\PublicController::getViewUrl('grille') }}">Grille</a>
    </label>
    <label class="btn btn-secondary @if(request('vue') == 'liste') active @endif">
        <a href="{{ \App\Http\Controllers\PublicController::getViewUrl('liste') }}">Liste</a>
    </label>
    <label class="btn btn-secondary @if(request('vue') == 'compact') active @endif">
