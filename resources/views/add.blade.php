            ...
            <form method="POST" action="/entreprise/ajout">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="alert alert-danger" role="alert">
                                ...
                                <ul>
                                    @foreach($errors->all() as $message)
                                        <li>{!! $message !!}</li>
                                    @endforeach
                                    <li>Prenez soins de renseigner de nouveau l'adresse complète de votre entreprise.
                                    </li>
                                </ul>
                            </div>
                        @endif
                        ...
                        <form method="POST" action="/entreprise/ajout">
                            ...
                            <div class="form-group row">
                                <label for="categories" class="col-md-3 col-form-label text-md-right">Catégorie
                                    *</label>
                                            ...
                                            @foreach($categories as $category)
                                                <li>
                                                    ...
                                                    <label class="form-check-label"
                                                           for="inlineCategoryCheckbox{{ $category->id }}">{{ $category->name }}</label>
                                                    <ul>
                                                        @foreach($category->children as $category_children)
                                                            <li>
                                                                ...
                                                                <label class="form-check-label"
                                                                       for="inlineCategoryCheckbox{{ $category_children->id }}">{{ $category_children->name }}</label>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                            ...
                            <div class="form-group row">
                                <label for="placeType" class="col-md-3 col-form-label text-md-right">Type d'entreprise
                                    *</label>

                                <div class="col-md-9">
                                    @foreach(App\PlaceType::all() as $type)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="placeType[]" type="checkbox"
                                                   id="inlinePlaceTypeCheckbox{{ $type->id }}" value="{{ $type->id }}"
                                                   @if(!empty(old('placeType')) && in_array($type->id, old('placeType'))) CHECKED @endif>
                                            <label class="form-check-label"
                                                   for="inlinePlaceTypeCheckbox{{ $type->id }}">{{ $type->name }}</label>
                                        </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                <label for="deliveryType" class="col-md-3 col-form-label text-md-right">Mode de
                                    distribution *</label>

                                <div class="col-md-9">
                                    @foreach(App\DeliveryType::all() as $type)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="deliveryType[]" type="checkbox"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control mt-2" id="inputAddress2" placeholder="Appartement, etc. (optionnel) " name="address[line2]" value="{{ old('address.line2') }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        ...
                        @error('region')
                            ...
                            <div class="form-group row">
                                <label for="phoneNumber" class="col-md-3 col-form-label text-md-right">No. de
                                    tél.</label>
                            ...
                            <div class="form-group row">
                                <label for="additionnalPhoneNumber" class="col-md-3 col-form-label text-md-right">No. de
                                    tél. add.</label>

                                <div class="col-md-9">
                                    <input id="additionnalPhoneNumber" type="text"
                                           class="form-control @error('additionnalPhoneNumber') is-invalid @enderror"
                                           name="additionnalPhoneNumber" value="{{ old('additionnalPhoneNumber') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="alert alert-secondary mt-3" role="alert">
                                        Vous pouvez entrer n'importe quelle adresse web, <strong>incluant celle de votre
                                            page Facebook</strong>!
                                    </div>
                            ...
                            <div class="form-group row">
                                <label for="deliveryZone" class="col-md-3 col-form-label text-md-right">Secteur desservi
                                    pour la livraison à domicile</label>
